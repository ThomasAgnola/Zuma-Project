    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            try
            {
                ...
                GameObject clone = Instantiate(Walker, new Vector3(gameObject.transform.position.x, gameObject.transform.position.y, gameObject.transform.position.z), Quaternion.identity);
